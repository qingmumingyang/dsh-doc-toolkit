...
import { normalizeCjkFonts, type DocToolkitConfig } from './types/config.js'
import {
  SKILL_CONTENT,
  SKILL_DESCRIPTION,
  SKILL_NAME,
 ...
 */
export function apply(ctx: PluginContext, config: DocToolkitConfig = {}) {
